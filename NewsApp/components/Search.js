...
const apikey='a5e51e1d3f0a471f97b4fc4082056a01';
...
const Search = () => {
  ...
  return (
    <div>
        ...
        <input className="form-control me-2 " style={{width:"27rem",border:"2px solid blue",margin:"2px"}} type="search" id='txt'value={item} onChange={(e)=>handleChange(e.target.value)} placeholder="Search Anything" aria-label="Search" />
      </form>

      <div>
        <NavLink className="nav-link text-center" aria-current="page" to="/domain">For Domain Search <u className='text-primary'>Click Here</u></NavLink>
